        ...
        <Grid container className={classes.root} spacing={16}>
            ...
            <Grid container justify="center" spacing={16} className={classes.content}>
                ...
                <Grid item xs={12} md={8}>
                    <p>Rachel and I (Caitlin) are so excited about our beautiful new studio! Together with our husbands and four young children among us, we bought this building on the corner of Beacon and Graham in July of 2018, and our families spent all summer renovating a building that was vacant for 12 years. After a lot of love and sweat, we proudly opened our beautiful new studio on October 1. As long-time residents of Beacon Hill, we are thrilled to be able to give back to our community, not only by renovating a space that was long-vacant, but by inviting all neighbors to participate in community-based fitness and wellness offerings.</p>
                    ...
                    <p>At South Seattle Fitness, we host a variety of programs.  We hold yoga classes including Vinyasa Flow and Hatha Slow Flow,  open to the all levels and genders;  we host FIT4MOM South Seattle classes, nurturing strength in motherhood through pre, postnatal and HIIT classes, within a positive and empowering community of women and families; Counterpoint Massage has found a new home here in our building; and we rent out our beautiful indoor/outdoor space for private events.</p>
